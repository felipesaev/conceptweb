        ...
        >
          <defs>
            <linearGradient
              ...
              id="squares-1-a"
            >
              <stop stopColor="#8a8b8b" offset="0%" />
              <stop stopColor="#565656" stopOpacity="0" offset="100%" />
            </linearGradient>
          </defs>
          <path
      ...
      >
        ...
        >
          <defs>
            ...
            >
              <stop stopColor="#565656" offset="0%" />
              <stop stopColor="#565656" offset="34.827%" />
              <stop stopColor="#565656" offset="100%" />
            </radialGradient>
          </defs>
        ...
        >
          <defs>
            ...
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="browser-c">
              <stop stopColor="#565656" offset="0%" />
              <stop stopColor="#d1d1d1" offset="100%" />
            </linearGradient>
            <filter
              x="-30%"
              y="-42.9%"
            ...
            >
              <stop stopColor="#565656" offset="0%" />
              <stop stopColor="#8a8787" offset="100%" />
            </linearGradient>
            ...
            <linearGradient
              ...
              id="browser-h"
            >
              <stop stopColor="#565656" stopOpacity="0" offset="0%" />
              <stop stopColor="#565656" offset="100%" />
            </linearGradient>
            <linearGradient
              x1="1.733%"
            ...
            >
              <stop stopColor="#565656" stopOpacity="0" offset="0%" />
              <stop stopColor="#565656" stopOpacity="0.513" offset="48.724%" />
              <stop stopColor="#565656" stopOpacity="0" offset="100%" />
            </linearGradient>
            <linearGradient
              x1="92.458%"
            ...
            >
              <stop stopColor="#565656" stopOpacity="0" offset="0%" />
              <stop stopColor="#565656" stopOpacity="0.513" offset="47.494%" />
              <stop stopColor="#565656" stopOpacity="0" offset="100%" />
            </linearGradient>
            <filter
              x="-23.1%"
            ...
            >
              <stop stopColor="#565656" offset="0%" />
              <stop stopColor="#a8a6a6" offset="100%" />
            </linearGradient>
            <filter
              x="-500%"
              y="-500%"
